...
if __name__ == '__main__':
    ...
    ds_train_no_zero = MNISTMetricDataset(mnist_download_root, split='train', remove_classes=[0])
    ...
    train_no_zero_loader = DataLoader(
        ds_train_no_zero,
        batch_size=64,
        shuffle=True,
        pin_memory=True,
    ...
    for epoch in range(epochs):
        print(f"Epoch: {epoch}")
        t0 = time.time_ns()
        train_loss = train(model, optimizer, train_no_zero_loader, device)
